...
#API connection
def Api_connect():
    Api_Id="AIzaSyDwiEP-NdxihXb5NLF9WTvg5D5--_fcRLM"
...
#Getting all channel information
...
client=pymongo.MongoClient("mongodb+srv://devimohan88:1234@cluster0.sar2usn.mongodb.net/?retryWrites=true&w=majority")
...
def channel_details(channel_id):
    ...
    coll1.insert_one({"channel_information":ch_details,"playlist_information":pl_details,
                        "video_information":vi_details,"comment_information":comment_details})
...
def channels_table():
    ...
    for index,row in df.iterrows():
        ...
        try:
            ...
            print("Channel values are already created")
...
def tables():
    ...
    videos_table()
    comments_table()
    return "Table created uccessfully "
...
with st.sidebar:
    ...
    menu_title=None,
    options=["Home","View Data"],
    icons=["house","View list"],
    default_index=0,
)
...
if st.button("Colect and store data"):
...
if selected=="View Data":
    ...
    question=st.selectbox("Select your question",("1.All the videos and the channel name",
                        ...
                        "5.videos with hirhest likes",
                        "6.likes of all videos",
                        "7.views of each channel",
                        "8.videos published in the year of 2022",
                        "9.Averaage duration of all videos in each channel",
    ...
    if question=="1.All the videos and the channel name":
        ...
        query2='''select channel_name as channelname,total_videos as number_of_videos from channels order by total_videos desc'''
        ...
        mydb.commit()
        t3=cursor.fetchall()
        df3=pd.DataFrame(t3,columns=["views","channelname","videostitle"])
        st.write(df3)
        ...
        query8='''select title as videotile,published_date as vieorelease,channel_name as channelname from videos
